    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="tableData" style="width: 100%" size="mini">
          ...
          <el-table-column label="登录名" width="100" align="center" sortable>
            <template slot-scope="scope">
        ...
        <el-dialog :title="operation?'新增用户':'编辑用户'" :visible.sync="dialogFormVisible" center>
          <el-form :model="dataForm" label-width="80px" size="small" label-position="right">
            ...
            <el-form-item label="登录名" :label-width="formLabelWidth" required>
            ...
            <el-form-item label="用户名" :label-width="formLabelWidth" required>
              <el-input v-model="dataForm.name" auto-complete="off" placeholder="请输入用户名" />
            </el-form-item>
            ...
            <el-form-item label="手机" :label-width="formLabelWidth">
              <el-input v-model="dataForm.mobile" auto-complete="off" placeholder="请输入手机" />
            </el-form-item>

            <el-form-item label="角色" prop="userRoles" label-width="120px">
                <el-input v-model="dataForm.picId" auto-complete="off" placeholder="请输入角色" />
            </el-form-item>
            <el-form-item label="状态" prop="lockFlag" label-width="120px">
             <el-input v-model="dataForm.status" auto-complete="off" placeholder="请输入状态" />
 </el-form-item>
          </el-form>
